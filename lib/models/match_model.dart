class MatchModel {
  ...
  MatchModel({
    ...
    this.p1Avatar = 'assets/models/avatar1.glb', 
    this.p2Avatar = 'assets/models/avatar1.glb',
  ...
  factory MatchModel.fromMap(Map<String, dynamic> map) {
    return MatchModel(
      ...
      p1Avatar: map['p1Avatar'] ?? 'assets/models/avatar1.glb',
      p2Avatar: map['p2Avatar'] ?? 'assets/models/avatar1.glb',
